...
public class LabelResourceIntTest {
    ...
    public void updateLabel() throws Exception {
        ...
        // Update the label
        Optional<Label> optionalUpdatedLabel = labelRepository.findById(label.getId());
        assertTrue(optionalUpdatedLabel.isPresent());
        Label updatedLabel = optionalUpdatedLabel.get();
