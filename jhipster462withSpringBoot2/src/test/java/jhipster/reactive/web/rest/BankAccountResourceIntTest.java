...
public class BankAccountResourceIntTest {
    ...
    public void updateBankAccount() throws Exception {
        ...
        Optional<BankAccount> optionnalUpdatedBankAccount = bankAccountRepository.findById(bankAccount.getId());
        assertTrue(optionnalUpdatedBankAccount.isPresent());

        BankAccount updatedBankAccount = optionnalUpdatedBankAccount.get();
