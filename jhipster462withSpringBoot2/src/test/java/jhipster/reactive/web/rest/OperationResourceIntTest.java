...
public class OperationResourceIntTest {
    ...
    public void updateOperation() throws Exception {
        ...
        Optional<Operation> optionnalUpdatedOperation = operationRepository.findById(operation.getId());
        assertTrue(optionnalUpdatedOperation.isPresent());
        Operation updatedOperation = optionnalUpdatedOperation.get();
