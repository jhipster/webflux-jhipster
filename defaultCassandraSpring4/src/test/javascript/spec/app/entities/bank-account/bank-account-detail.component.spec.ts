...
import { DefaultCassandraTestModule } from '../../../test.module';
    ...
    describe('BankAccount Management Detail Component', () => {
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                imports: [DefaultCassandraTestModule],
        ...
        describe('OnInit', () => {
            ...
            spyOn(service, 'find').and.returnValue(Observable.of(new BankAccount('aaa')));
            ...
            expect(comp.bankAccount).toEqual(jasmine.objectContaining({id:'aaa'}));
            });
        });
    });
