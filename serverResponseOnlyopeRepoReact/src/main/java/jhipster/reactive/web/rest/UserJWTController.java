...
public class UserJWTController {
    ...
    public UserJWTController(TokenProvider tokenProvider, ReactiveAuthenticationManagerAdapter authenticationManager) {
    ...
    @Timed
    public Mono<ServerResponse> authorize(@Valid @RequestBody LoginVM loginVM, HttpServletResponse response) {
        ...
        try {
            ...
            return authentication.flatMap((auth) -> {
                ...
                return ServerResponse.ok().syncBody(new JWTToken(jwt));
            });
        } catch (AuthenticationException ae) {
            log.trace("Authentication exception trace: {}", ae);
            return ServerResponse.status(HttpStatus.UNAUTHORIZED).syncBody(Collections.singletonMap("AuthenticationException",
