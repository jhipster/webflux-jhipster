...
public class AccountResource {
    ...
    public ResponseEntity registerAccount(@Valid @RequestBody ManagedUserVM managedUserVM) {
        ...
        return Optional.ofNullable(userRepository.findByLogin(managedUserVM.getLogin().toLowerCase()))
            .map(user -> new ResponseEntity<>("login already in use", textPlainHeaders, HttpStatus.BAD_REQUEST))
            .orElseGet(() -> Optional.ofNullable(userRepository.findByEmail(managedUserVM.getEmail()))
    ...
    public ResponseEntity<String> finishPasswordReset(@RequestBody KeyAndPasswordVM keyAndPassword) {
        ...
        return Optional.ofNullable(userService.completePasswordReset(keyAndPassword.getNewPassword(), keyAndPassword.getKey()))
              .map(user -> new ResponseEntity<String>(HttpStatus.OK))
              .orElse(new ResponseEntity<>(HttpStatus.INTERNAL_SERVER_ERROR));
    }
