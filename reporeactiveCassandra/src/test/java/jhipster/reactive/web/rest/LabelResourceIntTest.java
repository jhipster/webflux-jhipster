...
//public class LabelResourceIntTest extends AbstractCassandraTest {
//
...
//            .andExpect(jsonPath("$.[*].id").value(hasItem(label.getId().toString())))
...
//        // Get the label
//        restLabelMockMvc.perform(get("/api/labels/{id}", UUID.randomUUID().toString()))
